...
class Main:
    ...
    def banner():
        ...
        print(Font.Color.GREEN + text
              +
              Font.Color.WHITE + "| A COMPLETE OSINT TOOL:)      " + Font.Color.BANNER + "CODED BY karzo" + Font.Color.RESET + Font.Color.WHITE + "                      |\n|                                                                   |")
        print(Font.Color.WHITE + "|[+]" + Font.Color.GREEN + "VERSION:" + version +      Font.Color.WHITE +  "\t\t\tCURRENT-DATE: {}".format(Font.Color.GREEN + Date1) + 
              Font.Color.WHITE + "    |")
        print(
            Font.Color.YELLOW + "|Instagram:hackwithnature " + Font.Color.WHITE + "\t\t\tDATE-FORMAT: {}".format(Font.Color.GREEN + Country + Font.Color.YELLOW) + "          \n|Email:withnaturehack@gmail.com" + Font.Color.WHITE + "\tCLI-LANGUAGE: {}".format(Font.Color.GREEN + Lang + Font.Color.YELLOW) + "       |\n|GitHub:hackwithnature                                              |\n|Twitter:@hackwithnature                                            |\n|Linkedin:https://www.linkedin.com/in/hackwithnature                |")
        print(Font.Color.WHITE +
              "---------------------------------------------------------------------")
    ...
    def Mobile_Banner():
        ...
        print(Font.Color.WHITE + "A COMPLETE OSINT TOOL:)      " +
              Font.Color.BANNER + "CODED BY karzo" + Font.Color.RESET)
        print(Font.Color.WHITE + "\n[+]" +
              Font.Color.GREEN + "VERSION:" + version)
        print(
            Font.Color.YELLOW + "Instagram:hackwithnature\nEMAIL:withnaturehack@gmail.com\nGIT-HUB:hackwithnature\nTwitter:@hackwithnature\nLinkedin:https://www.linkedin.com/in/hackwithnature\n")
